        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuntityClips = table.Column<int>(type: "int", nullable: false),
                    AppUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SuccessfulCreated = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sponsorships_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sponsorships_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ChanelName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    Url = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Subscribers = table.Column<int>(type: "int", nullable: false),
                    PricePerClip = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Wallet = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SponsorshipTransaction", x => new { x.SponsorId, x.TransactionId });
                    table.ForeignKey(
                        name: "FK_SponsorshipTransaction_Sponsorships_SponsorId",
                        column: x => x.SponsorId,
                        principalTable: "Sponsorships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SponsorshipTransaction_Transactions_TransactionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YoutuberTransaction", x => new { x.YoutuberId, x.TransactionId });
                    table.ForeignKey(
                        name: "FK_YoutuberTransaction_Transactions_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_YoutuberTransaction_Youtubers_YoutuberId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "b139508b-15e9-4c2c-9424-b46c2cf71e10", "4edef44e-3985-42c3-9e03-7a39d9cab63b" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sponsorships_AppUserId",
                table: "Sponsorships",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Sponsorships_CategoryId",
                table: "Sponsorships",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SponsorshipTransaction_TransactionId",
                table: "SponsorshipTransaction",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_YoutuberTransaction_TransactionId",
                table: "YoutuberTransaction",
                column: "TransactionId");
        }
